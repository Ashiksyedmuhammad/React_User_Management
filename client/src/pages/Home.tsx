...
const Home = () => {
  ...
  return (
    ...
    <Theme />
      <div className={`info-container relative group flex flex-col gap-y-5 items-center justify-center w-[40%] h-[60%] border-[5px] rounded-xl p-5 mt-[10%] ${theme === 'dark' ? 'border-[#ddd8d525]' : 'border-[#5c5c5c] bg-[#e1e1e17e]'}`}>
